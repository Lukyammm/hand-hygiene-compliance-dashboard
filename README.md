...
## ðŸŽ¯ VisÃ£o Geral
**Hand Hygiene Compliance Dashboard** Ã© uma soluÃ§Ã£o focada na Ã¡rea da saÃºde e operaÃ§Ãµes clÃ­nicas. Este repositÃ³rio contÃ©m as ferramentas e os recursos necessÃ¡rios para melhorar processos, trazer clareza de dados e otimizar fluxos de trabalho. 
...
1. Clone o repositÃ³rio:
   `ash
   git clone https://github.com/Lukyammm/hand-hygiene-compliance-dashboard.git
   `
2. Acesse a pasta do projeto:
   `ash
   cd hand-hygiene-compliance-dashboard
   `
